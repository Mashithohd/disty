...
<form>
    ...
    <div class="mb-6">
        ...
        <label for="akses" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hak Akses</label>
        <select id="akses" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option selected>Pilih Hak Akses</option>
            <option value="a">Administrator</option>
            <option value="b">Guru</option>
            <option value="c">Orang Tua</option>
            <option value="d">Siswa</option>
        </select>
        </form>
    </div> 
    <div class="mb-6">
